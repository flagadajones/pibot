module.exports = function (io) {
    ...
    io.on('connection', function (socket) {
        ...
        socket.on('blink', function (val) {
            console.log("blink");
            //socket.emit("aaa_response", "reps")
            socket.broadcast.emit("blink");
        });
        socket.on('train', function (val) {
            console.log("train");
            //socket.emit("aaa_response", "reps")
            socket.broadcast.emit("train");
        });
        socket.on('reloadTrain', function (val) {
            console.log("reloadTrain");
            //socket.emit("aaa_response", "reps")
            socket.broadcast.emit("reloadTrain");
        });
        socket.on('faces', function (val) {
            console.log("faces", val);
            //socket.emit("aaa_response", "reps")
            //socket.broadcast.emit("reloadTrain");
        });
